...
This was tested with ami-c8cf3ba0 (64-bit EBS us-east-1 - Ubuntu 14.04 LTS)
See https://help.ubuntu.com/community/UEC/Images for info on Ubuntu images.
Latest Trusty Tahr: https://uec-images.ubuntu.com/releases/trusty/release/
 ...
 C. The instructions below will create a system based on Ubuntu 14.04 LTS.
    Add "--system precise" to the command in step 6 if you want Precise
    instead of Trusty. The "--big-boot" option enables an alternative way of
